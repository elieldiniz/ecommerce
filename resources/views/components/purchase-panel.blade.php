...
<div
    x-data="{
        variant: 'a1',
        precos: {
            a1: { preco: @js($precoA1), pix: @js($precoA1Pix) },
            a3: { preco: @js($precoA3), pix: @js($precoA3Pix) },
        },
    }"
...
>
    ...
    <a href="{{ $ctaHref }}" class="block rounded-lg bg-brand px-3 py-3 text-center font-heading text-sm font-semibold text-white">{{ $ctaTexto }}</a>
</div>
